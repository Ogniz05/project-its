...
export default function MultiMetricLine({ data }: Props) {
  ...
  return (
    <div style={{ width: '100%', height: 340, paddingBottom: 20 }}>
      <ResponsiveContainer>
        <LineChart
          data={data}
          margin={{ top: 10, right: 20, left: 0, bottom: 50 }}  // <-- aggiunto margine in basso
        >
